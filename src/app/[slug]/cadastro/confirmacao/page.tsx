...
export default async function Confirmacao({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-mega-bg px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-3xl font-bold text-mega-navy mb-4">Cadastro Enviado com Sucesso!</h1>
