  ...
  try {
    ...
    const [candidato] = await sql`
      INSERT INTO candidatos (
        ...
        naturalidade, nome_pai, nome_mae, chave_pix, pix_nao_possui, cep, endereco, numero, complemento,
        bairro, cidade, estado, telefone, celular, email, cpf, rg,
        orgao_emissor, data_emissao_rg, ctps, serie_ctps,
        possui_dependentes,
        ...
        ${body.nome_pai || null}, ${body.nome_mae || null}, ${body.chave_pix || null}, ${body.pix_nao_possui || false}, ${body.cep},
        ...
        ${body.serie_ctps || null},
        ${body.possui_dependentes || false},
